...
Answers feed a five-box Leitner scheduler on 1, 3, 7, 14 and 30 day intervals. A wrong answer drops one box instead of resetting, and only a question that was actually due can be promoted, so "mastered" means held across a month rather than answered four times tonight.
